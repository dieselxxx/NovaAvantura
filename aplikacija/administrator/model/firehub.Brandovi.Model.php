...
final class Brandovi_Model extends Master_Model {
     ...
     * @return array
     */
    public function lista (int $broj_stranice = 1, string $poredaj = 'Brand', string $redoslijed = 'asc', int $limit_zapisa_po_stranici = 10):array {
    ...
    public function IspisiZaglavlje () {
        ...
        return '
            <tr>
                <th width="15%" onclick="$_Brandovi(this,1,\'ID\',\''.$this->RedoslijedObrnuto().'\')">
                    <div>
                        <span>'._('ID').'</span>
                        <div class="poredaj">
                ...
                <th width="75%" onclick="$_Brandovi(this,1,\'Brand\',\''.$this->RedoslijedObrnuto().'\')">
                    <div>
                        <span>'._('Brand').'</span>
                        <div class="poredaj">
                            <svg class="gore '.$this->RedoslijedIkona('Brand', 'desc').'"><use xlink:href="/imovina/grafika/simboli/simbol.ikone.svg#strelica_gore"></use></svg>
                            <svg class="dole '.$this->RedoslijedIkona('Brand', 'asc').'"><use xlink:href="/imovina/grafika/simboli/simbol.ikone.svg#strelica_dole"></use></svg>
                        </div>
                    </div>
                </th>
            </tr>
