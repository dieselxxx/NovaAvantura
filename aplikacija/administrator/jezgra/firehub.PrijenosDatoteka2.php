...
final class PrijenosDatoteka2 {
    ...
    public function Velicina ():int {
        ...
        if (isset($this->input["size"])) {

            $this->velicina = $this->input["size"];
    ...
    private function _Datoteka ():string {
        ...
        if (isset($this->input["tmp_name"])) {
            ...
            $this->datoteka = $this->input["tmp_name"];
