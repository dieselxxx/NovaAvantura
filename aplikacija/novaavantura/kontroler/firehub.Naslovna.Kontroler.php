...
final class Naslovna_Kontroler extends Master_Kontroler {
    ...
    public function index (BazaPodataka $bazaPodataka = null):Sadrzaj {
        ...
        $artikli = $artikli_model->artikli(
            'izdvojeno', 0, 100, 'svi artikli', 0, PHP_INT_MAX, 'sve', 'sve', 'CijenaIliAkcija', 'asc'
        );
        ...
        $artikli_akcija_html = '';
        $artikli = $artikli_model->artikli(
            'akcija', 0, 100, 'svi artikli', 0, PHP_INT_MAX, 'sve', 'sve', 'CijenaIliAkcija', 'asc'
        );
        foreach ($artikli as $artikal) {
            ...
            $brandovi_html .= <<<Brand
                ...
                <div>
                    <a class="slika" href="/brand/{$brand_link}/" style="height: 100px; width: 200px;">
                        <img style="height: 70%; width: auto;" src="/slika/brand/{$brand['Slika']}" alt="" 
                        loading="lazy"/>
                    </a>
                </div>
