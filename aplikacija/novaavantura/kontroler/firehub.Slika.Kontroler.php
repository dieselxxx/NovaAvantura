...
final class Slika_Kontroler extends Master_Kontroler {
    ...
    public function malaSlika (string $kontroler = '', string $metoda = '', string $slika = ''):Slika_Interface {
        ...
        return (new Slika())->slika(FIREHUB_ROOT.'web'.RAZDJELNIK_MAPE.'novaavantura'.RAZDJELNIK_MAPE.'resursi'.RAZDJELNIK_MAPE.'grafika'.RAZDJELNIK_MAPE.'artikli'.RAZDJELNIK_MAPE.$slika)->dimenzije(400, 530)->napravi();
    ...
    public function velikaSlika (string $kontroler = '', string $metoda = '', string $slika = ''):Slika_Interface {
        ...
        return (new Slika())->slika(FIREHUB_ROOT.'web'.RAZDJELNIK_MAPE.'novaavantura'.RAZDJELNIK_MAPE.'resursi'.RAZDJELNIK_MAPE.'grafika'.RAZDJELNIK_MAPE.'artikli'.RAZDJELNIK_MAPE.$slika)->dimenzije(600, 800)->napravi();
